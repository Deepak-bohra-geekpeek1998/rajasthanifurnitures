            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <!-- <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>admin/add_product" class="btn btn-primary">Add
                                Tour</a></li>
                    </ol> -->
                </div><!-- /.col -->
            </div><!-- /.row -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo base_url() ?>admin/add_product" style="justify-content: flex-end;display: flex;">Add Product</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <?php if (!empty($select)) {
                                        foreach ($select as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="<?php echo base_url('assets/admin/product_images/' . $data['product_images']) ?>"
                                                        alt="" style="width: 100%;height: 90px;">
                                                </td>
                                                <td>
                                                    <a href="<?php echo base_url() ?>update_package/<?php echo $data['product_id'] ?>"
                                                        onclick="return confirm('Are you sure to Update?')"
                                                        data-toggle="tooltip" style="color: Black;" title="Edit"><i
                                                            class="fas fa-edit"></i></a>
                                                    &nbsp;
                                                    <a href="<?php echo base_url() ?>delete/<?php echo $data['product_id'] ?>"
                                                        style="color: Black;"
